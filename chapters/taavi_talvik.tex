...
oli Hewlett-Packard 85\index{Arvutid!HP-85}. 
...
Basic\index{Keeled!Basic} ja see, et ekraani peal sai jutte joonistada. Ja kui 
...
Tartu 10. Keskkool\index{Koolid!Tartu 10. Keskkool}, mis on tänapäeval  Mart 
Reiniku Gümnaasium\index{Koolid!Mart Reiniku Gümnaasium|see{Tartu 10. 
...
õnnetu HP-85-ga\index{Arvutid!HP-85}. Lõpptulemusena võeti mind umbes 
...
BSDI Unix\index{OS!BSDI Unix}, mis sai täiesti ausalt ostetud, \emph{source} 
...
Enam ei mäleta. kilu.nlib.ee\index{Masinad!kilu.nlib.ee} oli, ma arvan, 
SPARCStation 2\index{Arvutid!SPARCStation 2}.
...
Praegu olen sellises huvitavas ettevõttes nagu RebelRoam\index{RebelRoam}. 
