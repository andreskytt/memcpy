...
Treffner\index{Hugo Treffneri Gümnaasium}, mis oli 1. Keskkool, oli 
...
algklassilastele näha kooliarvuti Juku\index{Juku}. Ka mustvalge pildi 
...
Noorte Tehnikute Maja\index{Tartu Noorte Tehnikute Maja}, kus olid 
...
Noorte Tehnikute Majas\index{Tartu Noorte Tehnikute Maja}, oli vist 
...
Arvutustehnika \& Andmetöötlus\index{Arvutustehnika \& Andmetöötlus} 
näiteks. 
...
nii-öelda kooli-arvuteid, nõukogude-aegseid Agat-e\index{Agat}, 
Yamahasid\index{Yamaha} ja Jukusid\index{Arvutid!Juku}, et seal oli 
...
Agati\index{Agat} koju. Ja seal oli selline ekstreemne juhtum, kus 
...
Doom-i\index{Doom} demo või Wolfensteini\index{Mängud!Wolfenstein} 
...
\emph{chat-room}-id tulid hiljem. Random\index{Random} ja teised 
...
tol hetkel äkki Windows või oli OS/2\index{OS/2}, millega ma katsetasin. Aga 
...
Treffneris\index{Hugo Treffneri Gümnaasium}, mina ja Alari olime Miina 
Härmas\index{Miina Härma Gümnaasium}. Ja Mark\ldots Ütleme, et miks ma 
...
mida me ehitasime, oli arvutimäng nimega Drunkard\index{Drunkard}.
...
Software Wolfenstein\index{Wolfenstein 3D} oli juba 
väljas\sidenote{Avaldati 5. mail 1992} ja Doom\index{Doom} 
...
Ma kohutavat abstraheerisin selle asja üle. Kirjutasin C++-s\index{C++} 
...
koht. Seal oli näiteks üks Silicon Graphicsi\index{Silicon Graphics} 
...
kirjutasin Perlis\index{Perl} veebipõhise faktide saatmise ja vastu 
