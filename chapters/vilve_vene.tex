...
\enquote{Algoritm} koosseisu, Eestis tuntud lühendnime Algoritm all. Kuna 
asutus allus NSVLi tasemel kaitsetööstuse ministeeriumide gruppi, oli sellele
omistatud koodnimi Postkast A-3433 ja kehtestatud ka vastav töörežiim. 
...
projekteerimine) arendamise ja tiražeerimisega. Peale Tallinna olid 
...
Trahov\index[ppl]{Trahov, Tea}.\sidenote{Mõlemad tuntud 
...
maailmamudelid, mis päris elu üldiselt eriti ei toeta \ldots 
...
keskset Oracle' baasi, kus kõik maailma asjad sees olid, siis ühel hetkel läks
