...
Nairi-K\index{Nairi!Nairi-K} ja Nairi-2\index{Nairi!Nairi-2} vist. 
...
No ma õppisin Tartu 1. Keskkoolis\index{Tartu 1. Keskkool}, meil oli 
...
tolle AP 
programmeerimiskeelega\index{AP keel}\sidenote[][-2cm]{\begin{russian}АП 
...
ja  ma tegin Nairi-K\index{Nairi!Nairi-K} 
...
Ei tea. Sellest nagu ei olnud juttu. Too Nairi-K\index{Nairi!Nairi-K} oli 
nagu väiksem masin, teises toas oli Nairi-2\index{Nairi!Nairi-2}. Põhiliselt, 
...
Ülikool!Arvutuskeskus} oli ES\index{ES EVM}, kus üldse nagu ise arvuti 
...
mingisugune PDP-11\index{PDP-11} äkki?

Ma arvan, et umbes tollel ajal kuskil Anne Villems\index[ppl]{Villems, Anne} 
sebis need Apple II-d\index{Apple II} ka tegelikult siis Vanemuise 
...
igal pool. Apple'i peal nimetati teda Super Puckman-iks\index{Super 
...
Nojah, muidugi. Seal oli BASIC\index{BASIC}. Ütleme, et alguses ma 
kirjutasin ikkagi BASIC'us, aga pärast sai ikkagi valdavalt 
assembleris\index{Assembler} kirjutatud tolle pärast, et programm töötas 
oluliselt kiiremini kui sa ta assembleris tegid. 

\question{Kuidas BASIC'ust assemblerisse hüppamine käis? BASIC'u võib tõesti 
...
Sinna ta oli mingisuguses SCO UNIX'i\index{SCO UNIX} valmis pannud ja 
...
Quest\index{King's Quest}, mida me Taaviga mängisime seal Tähe tänaval. 
...
Too SCO UNIX\index{SCO UNIX} oli sinna juba ära installitud ja Tarmo 
...
Joost\index[ppl]{Joost, Ruta} ja kes seal kirjutasid, kirjutasid PL/SQL-i ikka 
...
ette. 1996 või 1997 sai see HP-UX'i\index{HP-UX} vastu välja vahetatud, enne 
