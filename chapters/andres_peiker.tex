...
Nairi-K\index{Arvutid!Nairi!Nairi-K} ja Nairi-2\index{Arvutid!Nairi!Nairi-2}. 
...
Ma õppisin Tartu 1. Keskkoolis\index{Koolid!Tartu 1. Keskkool} 
...
Nairi-K\index{Arvutid!Nairi!Nairi-K} peal valmis tegin, oli biorütmide arvutamise programm. Need olid tollal 
...
Sellest ei olnud juttu. Nairi-K\index{Arvutid!Nairi!Nairi-K} oli 
väiksem masin, põhiliselt kasutati teises toas olevat Nairi-2\index{Arvutid!Nairi!Nairi-2}. Meie sellele masinale eriti ligi ei saanud, too 
...
Apple'il oli selline standardne mäng nagu Pacman, mis oli ka mänguautomaatides ja mujal. Apple'il nimetati seda Super Puckmaniks\index{Mängud!Super 
Puckman}. Pean seda siiamaani kõige lahedamaks mänguks, mida olen kunagi 
...
\question{Nii et Pacman oli põhimõtteliselt samasugune nagu male?}
...
Jah, muidugi. Alguses 
kirjutasin Basicus\index{Keeled!Basic}, pärast valdavalt 
assembleris\index{Keeled!Assembler}, sest siis töötas programm 
tunduvalt kiiremini. 
...
tektsiredaktorit, pidid ise kirjutama, aga nüüd võtad millise iganes.}
...
Ta oli seal SCO UNIXi\index{OS!SCO UNIX} valmis pannud ja 
...
Hansapanka\index{Pangad!Hansapank} tööle.
...
Quest\index{Mängud!King's Quest}\sidenote{Sierra Entertainmenti seiklusmängude sari, mida peetakse oma 
...
\question{Kuidas sa Hansapanka\index{Pangad!Hansapank} sattusid?}
...
SCO UNIX\index{OS!SCO UNIX} oli sinna juba ära installitud ja Tarmo 
...
Hoiupangaga\index{Pangad!Hoiupank} liitumiseni. Siis toimus suur kultuuriline 
...
Joost\index[ppl]{Joost, Juta} kirjutasid usinasti PL/SQLi. Toda oli tõesti väga palju. Kasutajaliidese 
...
ette. Aastal 1996 või 1997 sai see HP-UXi\index{OS!HP-UX} vastu välja vahetatud. Enne 
...
Miloš Formani „Amadeus“, mida ma soovitan kindlasti kõigil vaadata, suurepärane 
