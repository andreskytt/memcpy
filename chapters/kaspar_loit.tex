...
\index[ppl]{Loit, Kaspar|see{BKnows}}
...
Tolle klassi ümber sagis palju rahvast, Karel Kannel\index[ppl]{Kannel, Karel} 
...
nii. Markus Klesman\index[ppl]{Klesman, Margus} toimetas seal näiteks. Raul 
...
.EXE-ni\index{Ajakiri!.EXE}. Kuidas sa nende juurde jõudsid?}
...
.EXE\index{Ajakiri!.EXE}, olgugi, et temast jäi mulje, et ta on ikka \emph{super 
...
kergesti kättesaadavad.\label{sidenote!adams}}, siis see oli väga oluline teos. Aga noh, minu jaoks 
