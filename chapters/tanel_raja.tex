...
MSX-id\index{Yamaha MSX}\sidenote{Koht, mis mujal jookseb läbi kui Tallinna Oktoobrirajooni Õppetootmiskombinaat, mida on vahel nimetatud Roopa tänaval asunuks ning mille kohta vahel öeldakse lihtsalt \enquote{Luise tänava klass}.}. Sama tüüpi aparaat, mis mul siin külje all 
...
Uralid\index{Ural}\sidenote{\begin{russian}Урал\end{russian} oli 
...
kontakti saime, selle nimi oli Poison Door\index{Poison Door}. Mingist 
...
toredat mängu nagu Wing Commander\index{Wing Commander} nende BBS-ist. 
...
System\index{HNS}\index{Hackers Night System|see{HNS}}. Mis oli, nagu 
...
PirnBox\index{PirnBox} oli üks ja oli veel muidki, aga sellised 
...
IV\index{King's Quest}, siis ei olnud niisugust võimalust, et lähed 
...
Larry\index{Larry}\sidenote{\emph{Leisure Suit Larry} oli Al Lowe poolt 
...
asja nagu .EXE\index{.EXE} kohta sinu käest. Räägi sellest palun 
natuke.}                 
...
Andmetöötlus\index{Arvutustehnika \& Andmetöötlus} ei olnud ju tegelikult ajakiri klassikalises mõistes oli rohkem 
nagu vihik.
...
Tentacle's\index{Day of the Tentacle}\sidenote{Legendaarse mängu Day of 
