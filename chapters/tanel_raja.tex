...
ka Habichti raamat \enquote{Selles mängus ei hüpata}\sidenote[][-2cm]{Juhan Habichti novellikogumik, mis ilmus 1993. aastal kirjastuse Katherine väljaandel.}. 
See mäng oli 
\enquote{Larry}\index{Larry (mängusari)}\sidenote[][-1cm]{\enquote{Leisure Suit Larry} oli Al Lowe'i
...
küberpunk\sidenote[][-2.4cm]{Allkirjastamata, kuid BKnowsi\index[ppl]{BKnows} piltidega 
