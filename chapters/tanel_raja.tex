...
\question{Mina ei jääks endaga kuidagimoodi rahule, kui ma ei küsiks sellise asja nagu .EXE\index{.EXE} kohta sinu käest. Räägi sellest palun natuke.}                 

Ajakiri oli osaliselt Microlinki püüd või isegi ambitsioon ennast nähtavale tuua.  Eestist oli tegelikult kaks arvutiajakirja tollal, oli Arvutimaailm\index{Arvutimaailm} ja .EXE. Arvutustehnika ja Andmetöötlus ei olnud ju tegelikult ajakiri klassikalises mõistes oli rohkem nagu vihik.
