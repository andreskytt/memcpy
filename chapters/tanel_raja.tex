...
Loondel\index[ppl]{Loonde, Jaak} oli seal Luise tänaval ja kus olid siis Yamaha 
MSX-id\index{Arvutid!Yamaha MSX}. Sama tüüpi aparaat, mis mul siin külje all 
...
Lausing\index[ppl]{Lausing, Tarmo} ja Virko Püss\index[ppl]{Püss, Virko}. Ja 
...
\emph{networking}-ut teha, olla niiöelda elu pulsil. Teine oli tavaliselt see, 
...
Esimene tõsiseltvõetav, just nimelt Fido mõistes, BBS oligi Hacker's Night 
System\index{BBS!HNS}\index{BBS!Hacker's Night System|see{HNS}}. Mis oli, nagu 
...
Seesama kamp oligi, Reimo\index[ppl]{Reimo, Tõnis}, Lausing 
\index[ppl]{Lausing, Tarmo} ja Virk\index[ppl]{Püss, Virko}.
...
selles mõttes, et vanus oli täpselt selline, et keegi on veel  täiskasvanud, 
...
Arvutimaailm\index{Ajakiri!Arvutimaailm} ja .EXE. Arvutustehnika ja 
...
nimelt arvutustehnika müügiga\sidenote{Näiteks Tartu Korel IN-i\index{Korel IN} 
müügimees Tiki\index[ppl]{Tiki}.}}
...
küberpunk\sidenote{Allkirjastamata, kui BKnowsi\index[ppl]{BKnows} piltidega 
lugu pealkirjaga \enquote{Kes sa selline oled, küberpunk?} ilmus .EXE kolmandas 
numbris 1994. aasta aprillis.}?}
