...
Innovatsioonipangast\index{Pangad!Innovatsioonipank}, see paneb selle sündmuse 
paika, eks ole. 
...
keskkool\index{Koolid!Tallinna 1. Keskkool}, Gustav Adolfi gümnaasium. Tollel 
...
Jaa! Meile õpetajate programmeerimist Fortranis\index{Keeled!Fortran} ja pagan 
...
raamatukogu ja muu on. Arvuti oli Minsk-32\index{Arvutid!Minsk!Minsk-32}, mis 
koliti just välja. Asemele kolis vist ES-1022\index{Arvutid!ES EVM!ES-1022}. Ma 
...
all olid Nairi-2\index{Arvutid!Nairi!Nairi-2}, AP keel\index{Keeled!AP} ja 
...
tänaval, kus olid Minsk-32\index{Arvutid!Minsk!Minsk-32} ja 
ES-1022\index{Arvutid!ES EVM!ES-1022}. ES-i numbriga ma võin eksida, aga 
...
SM-i\index{Arvutid!SM-4}, sellest samast suurest ES-ist ära toomine, see 
...
Varsti räägin ühest konkreetsest tööst, Lindra Reinuga\index[ppl]{Lindra, Rein} 
...
Iskra-226\index{Arvutid!Iskra!Iskra-226} peale, mis oli laetava Basicuga arvuti, 
...
\enquote{Innovatsioonipank\index{Pangad!Innovatsioonipank}\sidenote{18. 
...
See oli Midas Kapiti süsteem Kapiti, istus AS/400\index{Arvutid!AS/400} otsas. 
Aga kuna meil AS/400-t ei olnud, siis meil käis OS/2 Warp\index{OS!OS/2!OS/2 
...
Sotsiaalpank\index{Pangad!Sotsiaalpank} läks pankrotti, sealt pankrotipesast 
...
Mul oli on uus koht olemas, Tööstuspank\index{Pangad!Tööstuspank}. Üks 
...
milli oli läinud Rakvere Maapanka\index{Pangad!Rakvere Maapank}. Egas midagi, 
...
tollel ajal siis Ühispanka\index{Pangad!Ühispank}. Me tegime uut vinget 
...
Raepangast\index{Pangad!Raepank}. Tõnu helistab mulle, et \enquote{Kus sa oled, 
...
jõime ära ja oligi. Läksingi SEB panka\index{Pangad!SEB} kindlustuse 
...
Ütleme niimoodi, et SEB-s\index{Pangad!SEB} ma olin 17 aastat. Käisin küll 
