...
MUMPSi\sidenote[][-2cm]{\enquote{Massachusetts General Hospital Utility 
...
Lisaks oli võimalik anda \emph{wait}-aegu ehk „oota nii kaua ja siis mine edasi“, aga ma ei mäleta, mis sümbol 
...
\question{Sa oled ainus inimene, keda ma tean, kes on päriselt laulu sisse pandud.\sidenote[][-4.5cm]{Ansambli Folkmill 1996. aasta albumi \enquote{Paksult 
...
Millalgi siis jah. Ühel päeval ütles ta: „Kuule, hakkame tõsiselt 
...
andmebaasiga, mis jooksis PC platvormil, mitte miniarvutitel.}. 
...
üks\sidenote{Kommunismi kolm allikat 
