...
raamatu \enquote{Programmeerimine keeles PL/I\index{PL/I}} ja lugesin 
...
kolm SM-nelja\index{SM-4}. Need olid PDP-11\index{PDP-11} vene 
...
arvuteid\index{Yamaha MSX} terve klassi jagu. Siis tulid mõned 
...
Apple II\index{Apple II}. Ja mõned aastad hiljem tekkis IBM 
PC\index{IBM PC} sinna. See oli omapärane kogemus. Apple II peal olid 
...
tegutsemine. Ja no eks disassembler\sidenote{Programm, mis teeb masinkoodist 
oluliselt loetavamat assemblerit.} oli nagu sõber.
...
arvutivõrkude installeerija, ühtlasi .EXE\index{.EXE} kirjutaja.
...
\question{Aga miks? Jälle kõlab sellise suure hüppena, et ühel päeval tõmban kollast 
...
Forekspank sündis 1992. aastal, Forekspank ühines Raepangaga\index{Raepank} 
...
Hansapanga\index{Hansapank} tüdrukud istusid ka seal ja tegid märkmeid. Ja 
Hansapangal ei läinud ka rohkem kui mõni kuu, kui 
Telehansa\index{Hansapank!Telehansa} välja tuli.
...
Teleks oli viiekümne boodine\sidenote{\emph{Baud rate}, eesti keeles lihtsalt \emph{boodid}, 
näitab, mitu korda sekundis signaal liinil muutub andes indikatsiooni side kiirusest.} 
...
\question{Ta on \emph{circuit switched}\sidenote{Ahelkommuteeritud. 
On ju ilus eestikeelne sõna?}, eks? Siis ta vajas eraldi keskjaama?}
...
Windows\index{Windows} oli sel ajal olemas, Windows kolm küll veel. Ei olnud 
veel üheksakümmend viite. Ja siis korraldati konkurss. Tehke. Kõik lähenemised 
olid lubatud.

\question{Kes korraldas selle konkursi?}

Ma ei mäleta selle organisatsiooni nime\sidenote{Tegemist oli Eesti Informaatikafondiga\index{Eesti Informaatikafond}, sellest
sai hiljem Eesti Informaatikakeskus, Riigi Infosüsteemi Ameti eelkäia}. Aga  see oli mingisugune riiklik 
...
Windowsi\index{Windows} all käis. 
...
oli ka Pronto\index[ppl]{Pronto|see{Raja, Tanel}}\index[ppl]{Pronto}\sidenote{Vt.
 lk \pageref{sisu:pronto}.} tal kambas. Ja  veel paar 
...
server. Teda programmeeriti peamiselt platvormipõhises RPG II\index{RPG 
II} (\emph{Report Program Generator}) keeles} ajast veel. Sellest keelest 
...
PC\index{PC} ja selle peal käis System/36 emulaator, kus käis 
...
System i, oli IBMi keskmise suurusega serverite platvorm, mis 
...
\question{Rääkisin siin Tõnuga\index[ppl]{Samuel, Tõnu}\sidenote{Vt. lk \pageref{sisu:tonu}.} 
ja tema ütles, et Mast\sidenote{Ehk siis käesoleva loo kangelane.} oli see mees, kelle juurde sai minna riskantsete 
...
II\index{Apple II}s oli mitu tükki neid laienduskaarte sees. Kui sellel 
...
Ikka läks. Aga Apple II\index{Apple II} oli kõik tavalisest 
...
esimene IBM PC\index{IBM PC} oli selline, kus tulid kaasa (meil olid 
...
mõtled\sidenote{Pean silmas memcpy podcast'i kaanepildiks olevat fotot, kus peal 
...
\question{Ahti\index[ppl]{Heinla, Ahti}\sidenote{Vt. lk. \pageref{sisu:ahti}.} ütles kuidagi 
