...
turule tulnud Atari 8-bitiste arvutitega esimesi omataolisi, millel olid 
...
\enquote{Space Invaders}\index{Space Invaders}, ning 
...
nagu \enquote{Terrorist Handbook}.\sidenote[][]{Ilmselt peab Kain silmas William 
Powelli raamatut \enquote{The Anarchist Cookbook}. Vietnami sõja vastaste 
...
autori The Jolly Roger täiendused.} Igasugune 
...
jutuajamisel kaasas, selles puudus igasugune märge väljaandja ning trükkimisaja ja \mbox{-koha} kohta. Raamat oli 
korralikult köidetud ja kopeeris isegi värvilist kaanekujundust täpselt. 
Paigas olid ka sellised detailid nagu indeksis mõiste \emph{recursion}, mis viitas (nagu ka mõiste sisu nõuab) 
...
ITUga,\sidenote{Rahvusvaheline Telekommunikatsiooniliit.} kes 
...
aastal omanimelise ettevõtte 300-boodise modemi Smartmodem juhtimiseks. Käsustikust kujunes \emph{de facto} viis kõigi modmitega suhtlemiseks.} mis 
...
turul agressiivsete turunduskampaaniatega (ühel hetkel oli pool kõigist 
...
ja America Online (AOL).} siis neil oli tarkvara olemas. Mäletan, et 
...
eksi.\sidenote[][]{Siiski Mustamäe tee 4.} Ja see BBS kujutas endast aknalaual laiali laotatud arvutijuppe: seal 
oli USR Courieri\index{US Robotics!Courier} modem,\sidenote[][]{US Roboticsi 
...
Eesti Telekom,\sidenote[][]{Eesti Telekom ehk pika nimega Riigiettevõte Eesti 
...
börsile ja selle ainuomanikuks sai Telia.} mitte Eesti Telefon. See oli Eesti Telefonist täiesti eraldiseisev ettevõte. Huvitaval kombel oli kellelgi 
...
internetiühenduse kiirus sõltus veel väga suurel määral geograafiast, hoidis
...
\question{Kes teil toote poolt tegi või polnud siis veel niisugust mõistet nagu 
tootejuht?}
...
Kaupo Kalda\index[ppl]{Kalda, Kaupo}. Naljakas oli see, et Tiidu \emph{alias} oli Ott,\sidenote{OK tulenes asutajate nimedest Ott ja Kaupo.} kuigi
...
tagamaks, et aasta 2000 ei oleks arvutite arvates võrdne aastaga 1900. Aastal 2038 ootab meid sarnane probleem, kui Unixi-põhistes süsteemides kasutatav ajamääratlus talle mõeldud andmetüübi jaoks liiga suureks kasvab.} probleemi: kardeti, et arvutid 
...
Nokia 7110.\sidenote[][-3mm]{Tegu oli 1999. aastal uskumatult innovatiivse 
