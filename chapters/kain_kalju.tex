...
kellel oli  see Texas Instruments'i imepill, sai aasta hiljem 
...
\question{Ikkagi, võrreldes nende XTdega, mille abil Tartu Ülikoolis 
...
sadamast New Orleansi. Seal laevakompanii pani meid lennuki peale ja sealt 
...
Kaks nädalat, umbes neliteist-viisteist päeva võttis see laevasõit üle üle 
ookeani.
...
Technology (tuntud USAs kui Creative Labs) audiokaartide perekond. Need kaardid 
...
Kõikvõimalikke häkkimisvahendid, C-programmide näiteid, mingisuguseid raamatuid 
...
Inspektsiooni\index{Riigi Elektriside Inspektsioon|see{Tehnilise Järelvalve 
Amet}}, mis on täna Tehnilise Järelevalve Amet\index{Tehnilise Järelvalve 
...
inimesed võib-olla julenud arvuteid veel kasutada ja noored julgesid nendega 
...
klassitäie arvuteid ja siis B-klassi poiste ülesanne oli võrgutada see klass 
...
milleks oli  tolleaegne kümne megabitine koaksiaalkaabel ja, palun, siin on 
internet. See koaksiaalkaabel sai siis veetud kõikidesse ruumidesse. Ei mingeid 
hube ega täht-topoloogiat.

Siis ma avastasin enda jaoks interneti. Koolis loomulikult poiste rääkisin, et 
...
üsna kiired. Mäletan, et Tartu Ülikooli FTP serverist sai kahe megabitise 
...
400\sidenote{Inteli nomenklatuuris olid \enquote{DX} tähistusega protsessorid 
...
hiljem on väga kasulikuks osutunud oli see, et modemid töötasid AT 
käsustikuga\index{AT käsustik}\sidenote{Hayes käsustik, tuntud ka kui AT 
käsustik, on käsukeel, mille Dennis Hayes\index[ppl]{Hayes, Dennis} lõi 1981. 
...
nimega FrontDoor, mis helistas, ja oli soft, kes  pakkis kokku FidoNeti 
\emph{echo}d ja  saatis  selle paki edasi. Aga BBSil, kui sellisel ei olnud 
kliendi softi. Läksid lihtsalt \emph{telnet}iga külge ja hakkasid seal edasi 
tegutsema.
...
BBS-laadsetest ja internetiteenustest. Neist suurimad olid CompuServe, Prodigy 
...
arhitekti, tal oli selline väike arhitektibüroo,  ning meil oli julgus  
...
BBSide ja varaste internetipakkujate lemmik, ka Eestis},  emaplaat, toiteblokk  
...
tundus, et ISP, et see tegelikult veel huvitavam asi, sellepärast et nad 
...
Jah. Jaanus on selline tohutu pedant,  tohutu  töövõimega kataloogiseerija. 
...
programmeerija ja arendasin tarkvara ja Jaanus oli  katalogiseeria.  Kui Jaanus 
...
tegema ühte ärikataloogi sarnast teenust,  mille pealkiri oli Partanet. See 
...
\question{Suure hulga failide indekseerimine ei ole enam päris nalja-asi ja 
...
Eesti veebiruumis, mis on originaalkujul originaal aadressil. 
...
reklaami ja nii edasi, umbes selline kokkulepe oli. Nord Decor\index{Nord Decor} 
oli tolle agentuuri nimi, ma ei tea, kas see kellelegi midagi ütleb. Aga, aga 
selles mõttes oli huvitav, et üks kolleeg, kes Nord Decor'is töötas, oli kunagise 
...
Tiit}. Kusjuures oligi nagu naljakas, et tema alias oli Ott ma tegelikult tema 
...
Telefon\index{Eesti Telefon}  Estpak Data\index{Estpak Data} ära söönud, Etspak 
...
Kontorikontoriruumi jagasin ma ühe ühe teise noormehega, kes arendas 
...
kuulnud, aga see oli selline \emph{wideband} protokoll, mis töötas üle GSM-i. 
...
koodi optimeerida}. Kuna pikka aega leiti aasta-arvu hoidmiseks kahekohaline 
...
sellesse meie enda privaatkseskusse sisse sellesama V.35  protokolliga ja 
hakkasin  vaatama, et mille pärast siis Hoti kliendid siis sisse helistada ei saa. 
...
automaatne. \emph{Self-service}, kasuta saab ennast ise registreerida ja nii 
...
kujutad sa ette,  kahe nädala pärast me olime \emph{live}'s. See tähendab, et 
...
Praegu ma olen Bolt\index{Bolt} serveri infra peal.  Minu üks kaua-aegseid 
...
serverite poole majandamist Bolt'is, siis meil oli stiilis tuhandeid kliente ja 
