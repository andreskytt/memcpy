...
Väga võimalik, et see tuli stiilis .EXE ajakirjast\index{Ajakiri!.EXE}, ma ei suuda 
...
Paigas olid ka sellised detailid: indeksis mõiste \enquote{recursion} viitas 
samale indeksi lehele. Mart Parmas\index[ppl]{Parmas, Mart} mäletab, et raamatut 
...
\emph{introduction} kursuseid. Tollel ajal ilmus ka ajakiri .EXE\index{Ajakiri!.EXE}, 
...
OK Jutuka\index{Jutukad!OK}\sidenote{OK Jutukas oli üks esimesi tõeliselt massidesse läinud 
...
Hansapangas\index{Pangad!Hansapank} nurja läks, meil miskipärast ei tulnud pähe mõtet 
