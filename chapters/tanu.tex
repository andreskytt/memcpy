...
\begin{description}
	...
	\item[Vootele Voit ja Mart Palmas]\index[ppl]{Voit, Vootele}\index[ppl]{Palmas, Mart}  aitasid mitmeid asjaolusid mäletada 
	\item[Gert Silling]\index[ppl]{Silling, Gert} aitas jõuda Ants Roose\index[ppl]{Roose, Ants} ja Algoritmini ning Ants Roose, kes andis infot legendaarse Arvutustehnika ja Andmetöötluse ning Algoritmi kohta 
\end{description}
