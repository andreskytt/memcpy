...
terminal, mis käis Datasaabi\index{Datasaab}-nimelise\sidenote{Datasaab oli Rootsi lennukitootja Saab arvutustehnoloogia 
eraldi ettevõtteks kasvanud divisjon, kus toodeti nii tsiviil- kui ka
militaarkasutuseks mõeldud arvuteid.} 
...
organisme.\sidenote[][-1.3cm]{Tõenäoliselt oli lindil Briti 
matemaatiku John Horton Conway välja mõeldud rakuautomaat, mida tuntakse 
nime all \enquote{Game of Life}. Tegu on mängijateta mänguga, mis ainsa sisendina 
...
Maksu- ja Tolliameti teenindussaal aadressil \mbox{Endla 8.}.} Seal kolmandal 
...
kirjutan, nagu PHP\index{PHP} ja JavaScript\index{JavaSctipt}. Need 
...
Arvutiks oli Sanyo PC ja see oli väga vinge. Seal oli muuseas olemas ka Apple II\index{Apple II}, mille peal sai mängitud \enquote{Karatekat}\index{Karateka}. Ja kui ma 
...
Instituut,\sidenote{Ei ole selge, mis asutust Peeter 
...
vaprad raadioruhvi ja füüsikaklassi tagaruumi noored organiseerisid 
...
\question{Mis seltskond seal raadioruhvi ja füüsikaklassi tagaruumis koos käis?}
...
ajalugu\sidenote[][]{Nõukogude ajal kuulus ülikooli{\-}hariduse juurde kohustuslikus korras \enquote{punaste ainete} 
...
eriti kui normaalsed inimesed kasutavad vähemasti Z80, mitte 8080. 
...
diagnostikakeskust\index{Diagnostikakeskus},\sidenote[][-1.3cm]{1988. aastal asutatud Diagnostikakeskus oli omal 
...
mõttes. Et kuhugi külge minna, peaks seal olema huvitav, ning selleks omakorda 
...
olid mööda maailma laiali, olid juhuslikult kaasas ka pruunid ümbrikud 
...
peale panna paber koos kollase post-it'iga, kus on telefoninumber, siis on see 
...
Goodwin BBSi \emph{point}id. Seal oli hädasti vaja ja uhkus jäeti kõrvale. 
...
õlletoas ja mõtlesime välja saate \enquote{Tehnokratt}. Juba esimesel hooajal sattusime Kukus kokku 
...
originaalidega. Kui \mbox{PDFindus} hakkas meile endale majja tulema, siis 
