...
arvan, äkki oli see  Minsk\index{Minsk}. Seal ma sain tuttavaks ühe 
...
Ei. See on legendaarne arvutiklubi Juta\index{Juta}, mida vedas 
...
Klubis õpetati meile programmeerimist keeles PL/I\index{PL/I}.
...
mööda SM-4\index{SM-4}, mille külge oli ehitatud mingisugune teksti-TV 
...
vinge ES\index{ES EVM}. Teine koht oli see, kus Endla tänaval asub (või 
...
korrusel olid Ehituskomitee\index{Ehituskomitee} ES-id\index{ES EVM}. 
...
kirjutama nagu  PHP\index{PHP} ja JavaScript{JavaSctipt}. Need 
...
Sanyo PC, väga vinge. Seal oli muuseas ka Apple II\index{Apple II} 
olemas, mille peal sai mängitud Karatekat\index{Karateka}, minu arust 
...
Tehnikaülikool!Santehnika Kateeder} SM-4\index{SM-4}. Ehituse all oli 
...
SM-4\index{SM-4}, mis oli  enam-vähem niisugune masin, mille ma kohale 
...
oli klassitäis Yamaha MSX-e\index{Yamaha MSX}. Tolle klassiga seoses on 
...
PirnBoxi\index{PirnBox} nimeline  BBS, mis asus seal kusagil, kus trammid 
...
System}\index{HNS}. Ja siis kolmas oli Goodwin BBS\index{Goodwin} meil 
...
Ülikoool\index{Kaunase Ülikool} ja Leedu parlament, kes olid 
...
Arvutimaailma\index{Arvutimaailm} ja kuhu iganes. 
...
esimene avalikustatud töö oli Pikri\index{Pikker} mingisugune noorte 
