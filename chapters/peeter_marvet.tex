...
füüsikavõistlus ja meid viidi ka arvutisaali, kus oli Minsk\index{Arvutid!Minsk}. Seal sain tuttavaks ühe aasta vanema
koolivennaga, 
...
organisme\sidenote{Tõenäoliselt oli lindil Briti 
...
Ei, see oli legendaarne arvutiklubi Juta\index{Arvutiklubi!Juta}, mida vedas 
...
Klubis õpetati meile programmeerimist PL/I\index{Keeled!PL/I} keeles.
...
üks väheseid kohti, kus ma ise pole käinud. Seal oli SM-4\index{Arvutid!SM-4}, mille külge oli ehitatud teksti-TV 
...
vinge ES\index{Arvutid!ES EVM}. Teine koht oli Endla tänaval, kus asus Maksuameti maja\sidenote{2013. aastani asus 
Maksu- ja Tolliameti teenindussaal aadressil Endla 8.}. Seal kolmandal 
korrusel olid Ehituskomitee\index{Ehituskomitee} ESid\index{Arvutid!ES EVM}. 
...
kirjutan, nagu PHP\index{Keeled!PHP} ja JavaScript{Keeled!JavaSctipt}. Need 
...
Arvutiks oli Sanyo PC ja see oli väga vinge. Seal oli muuseas olemas ka Apple II\index{Arvutid!Apple II}, mille peal sai mängitud Karatekat\index{Mängud!Karateka}. Ja kui ma 
...
Tehnikaülikool!Santehnika kateeder} oli olemas SM-4\index{Arvutid!SM-4}. Ehituse all oli 
...
SM-4\index{Arvutid!SM-4}, mille ma kohale 
...
Mina käisin algusest lõpuni Reaalkoolis ja keskkooliajal tekkisid arvutid ka meie kooli. Saime klassitäie Yamaha MSXe\index{Arvutid!Yamaha MSX}. Kuna erinevate koolide vahel oli masinate saamiseks 
...
ajalugu\sidenote{Nõukogude ajal kuulus ülikoolihariduse juurde kohustuslikus korras \enquote{punaste ainete} 
...
modem. Mingi koha peal lähevad boodid ja bpsid vist lahku\sidenote{Bps (\emph{bits per second}) on sekundis edastatavate bittide hulk. \enquote{Boodid} (\emph{baud rate}) näitavad aga, mitu korda 
...
oli ürituse jaoks oluline. Mart Siilman, endine Fila direktor\sidenote{Eesti NSV Riiklik Filharmoonia\index{Eesti Riiklik 
...
Heinleini 1958. aasta jutustus „Have Space Suit --- Will Travel“.}. 
Loomulikult leidsime üles ka selle, et on olemas BBSid. 1989. 
aasta lõpus tekkis Lembit Pirnil\index[ppl]{Pirn, Lembit} esimene 
PirnBoxi\index{BBS!PirnBox}-nimeline BBS, mis asus praeguse SEB taga, kus trammid toona kõva kriginaga keerasid, 
...
System}\index{BBS!HNS}. Kolmas oli Goodwin BBS\index{BBS!Goodwin} meil 
...
Arvutimaailma\index{Ajakiri!Arvutimaailm}. 
...
esimene avalikustatud töö oli Pikri\index{Ajakiri!Pikker} noorte 
