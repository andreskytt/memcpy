...
minna tema isa töö juurde. Ülo\sidenote{Kermo isa, akadeemik Ülo Jaaksoo\index[ppl]{Jaaksoo, Ülo}.} töötas sel ajal 
...
Ma käisin 1. keskkoolis.\index{Tallinna 1. Keskkool}\sidenote{Praegu Gustav Adolfi Gümnaasium.} Kui lastelt küsitakse, kelleks nad saada tahavad, siis tavaliselt 
...
Uudelepp\index[ppl]{Uudelepp, Helgi}\sidenote[][-2cm]{Gustav Adolfi 
...
Pentus näiteks\index[ppl]{Pentus, Mati}\sidenote[][-2.2cm]{Mati Pentus on Eesti 
matemaatik, alates 2003. aastast Moskva Riikliku Ülikooli professor.}), probleem oli koolist üldse välja jõuda. Rajoonist sai 
niikuinii vabariiklikule edasi.\sidenote[][-1.5cm]{Toonased olümpiaadid olid organiseeritud kooli-, rajooni- ja 
...
tema käis Küberis\index{Küber} interneti küljes. Oli niisugune programm nagu \emph{talk}: 
...
Jaapanlased võibolla saavad keerulise asjaga ka hakkama, aga meie ei saa. Ja 
