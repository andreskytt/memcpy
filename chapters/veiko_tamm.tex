...
Peterburist.\phantomsection\label{sisu!veiko_moskvas}
...
Mõtlesime, et Tartu Kommertspank\index{Tartu Kommertspank}\sidenote[][-3.6cm]{1988. 
...
\question{Kas sa teiste Eesti \emph{sysop}'idega ka suhtlesid?}

Jah, ikka, meil olid igasugused üritused: BBSummerid\index{BBSummer} ja 
BBWinterid\index{BBWinter}. Seal käisid nii \emph{sysop}'id kui ka kasutajad. See oli 
...
Olid ka füüsilised raamatud. Suuremad fännid, nagu Jack,\sidenote[][-23mm]{Veiko ei pea silmas ei Jaak Lippmaad ega ka Jaak Loondet, 
keda sama nime all tunti. Gibsoni tõlkimisega tegeles hoopis Veiko tuttav Jaak Tomberg\index[ppl]{Tomberg, Jaak} (Gibson, William, Jaak Tomberg, Esta Tatrik, Peeter Talvistu, Tõnu Kaalep ja Bruce Sterling. Põlev Kroom. Tallinn: Tänapäev, 2002).} tõlkisid neid eesti keelde ja isegi 
...
\emph{underground}'iga tuttavaks. Olin ka ICE piraadigrupi liige, 
...
\enquote{Sa vaatasid Windowsi, kas sa saad sellistele asjadele ligi? Kuule, Soome kolleegid näitasid SPSS\sidenote[][]{Algselt IBMi 
...
\question{Mis aastal sul esimene \emph{online}-mäng tuli?}
...
\enquote{Dungeons \& Dragonsit}.\sidenote[][-1.8cm]{\enquote{Dungeons \& Dragons}, tihti lühendatud ka 
...
Narusberg\index[ppl]{Narusberg, Arlis} ja Uuk.\sidenote{Kaupo Paabo\index[ppl]{Paabo, Kaupo}.} DnD üks esimesi maaletoojaid oli vana 
...
Nagu öeldakse, peab tundma \emph{\begin{russian}русская душа\end{russian}}'d, vene 
...
päevikuid}\sidenote{Lem, Stanis{\l}aw. Loomingu Raamatukogu nr 22. Ijon Tichy 
...
Ühesõnaga, tegin HP loo ära ja pärast tuldi uusi lugusid \mbox{küsima}. Suur osa nooremast 
põlvest ei tunne raudvara, aga raud{\-}vara-aja{\-}kirjan{\-}dusega on see lugu, 
...
esimese \enquote{EverQuesti}\index{EverQuest} peamine aju.\sidenote{\enquote{EverQuesti} kaasautor ja \enquote{Pantheoni} tootjafirma loovdirektor Brad McQuaid suri 2019. aasta lõpus, ajasime Veikoga juttu sama aasta algul.} Kutsume oma paljude 
...
\enquote{The Secret Worldis} oli kohti, kus pidid näiteks võtma midagi kiilkirjas või 
