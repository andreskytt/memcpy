...
asunud asutus \begin{russian}НПО „Научный Центр“\end{russian}, 
...
kvaliteediga Roxette'i\sidenote{1986. aastal moodustatud Rootsi 
...
omaaegne hittlugu „Disko“ on loodud SoundClubii abil ja, nagu tegijad on meenutanud, 
...
käes igasuguseid \emph{fork}'e. Kui \emph{fork}'ide hierarhiat 
...
oma Estonia-nimelist asja arendama. Tolle versiooniga mina liitusingi. Sai seda maailma edasi arendatud ja kohendatud, vigu 
parandatud ja muid asju tehtud. 
...
aastat ja sisaldas umbkaudu poolt praegusest magistrikraadist.}}
...
teada-tuntud IT-tegijad. Üks tuttav nimega Elvar Vask\index[ppl]{Vask, Elvar} alias 
...
\question{Sa pidid kiusatusele kõvasti vastu seisma, sest mina libastusin 
...
teistpidi otsustades oleks mu elu võibolla praegu teistsugune. Üks variant oli Medisoft ja teine see punt, kus meie sõbrad Rene Prillop\index[ppl]{Prillop, Rene} 
...
Visual Studios DigiDoci kliendi prototüüpi või mingit visiooni klienti. 
...
Mooncascade'i visioon tekkis mul juba tol hetkel, aga kui ma 
