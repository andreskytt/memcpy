...
SMid \index{Arvutid!SM EVM}\sidenote{\begin{russian}Система Малых ЭВМ (СМ 
...
Iskrat\index{Arvutid!Iskra}\sidenote{\begin{russian}Искра\end{russian} oli 
...
Pascalit\index{Keeled!Pascal} õppima seepärast, et 
mulle sattus kätte Jürgensoni pruunide kaantega Pascali  
raamat\index{\enquote{Programmeerimine Pascal-keeles}}\sidenote{Rein Jürgensoni 
...
leidsin, et Assembler\index{Keeled!Assembler} on see päris asi. Kuna tol 
...
Eestisse sellise asja nagu DataFlex\index{Keeled!DataFlex}. Tegu oli päris 
...
Questid\index{Mängud!Space Quest} ja muud, tulid viie-kuue flopi 
...
tõmbasid öösel HNSi\index{BBS!HNS} tühjaks ja 
...
praegune Danske\index{Pangad!Danske Pank}\index{Pangad!Danske 
...
Forekspangas\index{Pangad!Forekspank} infotehnoloogiliselt selline elu nagu 
tänapäeval. 
