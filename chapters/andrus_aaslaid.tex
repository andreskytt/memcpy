...
\begin{russian}Техника - молодёжи\end{russian}'t\sidenote{Aastast 1933 ilmuv algselt Nõukogude ja nüüd Vene populaarteaduslik ajakiri.}. Lappasin siis pööningul neid ajakirju, detektoriklapid peas. 

Igatahes ükskord astusin ma tuppa, lülitasin Melodija sisse ja sealt öeldi, et 
Tallinna 43. Keskkool\index{Koolid!Tallinna 43. Keskkool}\sidenote{Täna Tehnikagümnaasium\index{Koolid!Tehnikagümnaasium|see{Tallinna 43. Keskkool}}} on otsustanud hakata 
...
\question{Aga kust sa siis pärit oled, et niimoodi Tallinna kooli pidi 
minema?}
...
\question{No mõni ime, et te Mastiga\index[ppl]{Kaal, 
...
\question{Kas seal sinu ajakirjade hulgas juba arvutiajakirju ka oli?}
...
SM-id tollel ajal\index{Arvutid!SM EVM}\sidenote{\begin{russian}Система Малых ЭВМ (СМ ЭВМ)\end{russian} oli mitmete Nõukogudemaal toodetud, enamasti lääne analoogidel põhinevate, arvutitüüpide üldnimetus.}. Ja 
...
Selle CP/M-i masina peal ma niisama natuke klõbistasin aga 
SM-4\index{Arvutid!SM-EVM!SM-4}\sidenote{SM-4 oli PDP-11/40\index{PDP-11} ühilduv 
...
\question{See oli siis enne seda, kui sa otsustasid, et nüüd sa oled 
...
\question{Kas selles 43. keskkoolis valmistati päriselt ette ka 
...
Peeter Grossberg\index[ppl]{Grossberg, Peeter} teda tegid. Selles mõttes 
...
algselt loodud CP\textbackslash M operatsioonisüsteemile.} arvestusest TPI-s kus 
...
\question{Aga kuidas sa ikkagi selle programmeerimise juurde jõudsid? Sa 
pidid ikka kuskil seda harjutada saama?}
...
Eero Tohvriga\index[ppl]{Tohver, Eero} ulatati kümnendas klassis arvutiklassi võtmed ja hakati 
...
tuli Tarmo Mamers\index[ppl]{Mamers, Tarmo} ja küsis, et kas ma ikka päris tööd ei 
taha teha, et Skriining\index{Skriining} otsib programmeerijat. 

Nii ma sattusin Skriiningusse Kalle Lotamõisa\index[ppl]{Lotamõis, Kalle} juurde 
...
Mina olin siis keskkoolis, esimese \emph{node} panin püsti hiljem. Ma olingi vist Aare \emph{point}. 
...
ja seal olid kõvad mehed nagu Mast\index[ppl]{Mast} ja  Marx\index[ppl]{Marx|see{Kliimask, Margus}}\index[ppl]{Kliimask, Margus}  ees, kes olid oma ökosüsteemi püsti pannud, ühele BBS-ile seal rohkem ruumi ei olnud. 
...
novembris, mis lõpetas siis Danske\index{Pangad!Danske Pank}\index{Pangad!Danske 
Pank|see{Forekspank}} nime all aga alustas Forekspangana\index{Pangad!Forekspank|see{Eesti Forekspank}}. See 
...
jooksis ja selle kaabli olemasolu oli IT-inimeste unelmates kesksel kohal} sisse?}
...
\question{Millest ma siis järeldan, et toona oli maailm teistsugune. Internet ei 
olnud veel kommertsiaalne vaid pigem kogukondlik nähtus?}

Selle eest vististi ikka keegi maksis ka kellelegi lõpuks midagi, aga kui palju, 
...
\question{See jutt läheb ju kokku sinu kunagise ettevõtte uksest sisse minekuga: 
