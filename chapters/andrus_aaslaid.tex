...
raadiotehase\sidenote{A. S. Popovi nimelime Riia Raadiotehas, alates 1951 Rigas 
...
Ma ei oskagi öelda, ma ei ole sada protsenti kindel, kumb oli enne, kump oli 
pärast. Et et kas, kas see huvi, et tulla Tallinnase mängis rolli. Ega nad ju 
...
\textbf{\enquote{Kas selles 43. kekkoolis valmistati päriselt ette ka 
...
varas, või sa ei ole varasidega või kas sa tahad terve firma ära varastada või 
...
\enquote{superandmebaasi}, mis sisaldas iskustatud andmeid autode, (toona üsna 
...
politseioperatsiooni käigus} ja kopeeris ära kellelegi andmebaaside, eks iga 
...
olemas. \emph{Point}i püstipanemine käis ka loomulikult läbi läbi TPI. Tarmo 
...
meie kogemus ütleb, et kui te juba sihukse jutuga te tulete, siis mitte keegi 
...
olnud isegi \emph{mainrframe}, see oli mingi mini. Ja  see oli vaja siis 
...
lihtsalt niisama. Need numbrid on neljakohalised. Ma sisestan neli numbrit ära, 
...
korrusel. Hiljem oli seal siis epitsenter siis, kui siina läksid veel tööle 
...
BBSi-i omaniku BBSi lasta neljaks tükiks kaks korda tunnis ilma mingite 
probleemideta, aga seda lihtsalt ei tehtud.  Sellepärast et see oli nagu 
saarlase ukselukk. Et kui sa oled paika pannud väljaspoole ukse ette, siis kõik 
teavad, et sind ei ole kodus ja ja nii on. Et ei ole vaja katsetada, et kas uks 
...
\emph{node}ks registreerida. Et BBS isenesest eeldanud midagi sellest, lihtsalt 
modem ja vastava tarkvara olemasolu. Kuskil mingeid hämaraid teid pidi levisid 
...
mõnitooritud vist. Mingisuguseid probleeme ma ei tea, et kellelgi oleks 
kaheksakümnendatel olnud nende modemi modemiga sidepidamisega ei Eesti ega 
...
ära, nii et tegelikult  kaheksakümmendate lõpus, üheksakümmendate alguses see 
...
\textbf{\enquote{Kas eksisteerimis mingi spetsialiseerumine ka, et siit ma saan 
...
See oli see aeg, kus juba esimesed need sellised suuremat kõvakettad tekkisid. 
...
siis ilmselt jätkuks eluajaksL sinna saaks kõik mängud peale panna, kõik 
...
Windowsi või DeskView'd\index{DeskView}\sidenote{DeskView oli kaheksakümnendate 
...
sisuliselt korjasin kokku kõik, mida ma kätte sain ja pakenteerisin ringi. See 
...
endale  asemele. Et nagu \emph{tag}iti ära nagu \emph{graffity}ga, et see on 
...
ja seal olid kõvad mehed nagu Mast\index[ppl]{Mast} ja  Marx\index[ppl]{Marx|see{Kliimask, Margus}}\index[ppl]{Kliimask, Margus}  ees, kes olid 
oma ökosüsteemi püsti pannud, siis ühele BBSile seal rohkem ruumi ei olnud. 
...
Pank|see{Forekspank}} nime all aga alustas Forekspangana\index{Forekspank}. See 
oli jälle omaette selline innovatiivne pangandustoode. 

\textbf{\enquote{See oli väga äge pank omal ajal. Miks sa sinnna läksid? 
...
Füüsika Instituut (KBFI). 1979. aastal Endel Lippmaa\index[ppl]{Lipmaa, Endel} 
poolt loodud teadusasutus. Tuntud ka kui \enquote{Lipmaa Instituut}. Just 
...
samal päeval, kui paavast sõitis ringi oma mobiiliga, käisime kaablikeraga. 
...
jah, midagi ei küsitud ka. Natukene oli seal vist vajab mingit häkkimist ka, et 
...
esimese internetibrausereid ja mängis WWW populariseerimisel olulist rolli. 
Sama meeskond lõi hiljem Netscape\index{Netscape} Navigtatori, mis omakorda on 
...
\emph{boring}. Tahtmata anda hinnangut mingisugustel inimgruppidele, aga   
...
kogu aega. Aga kui sellised nohkarid lõpuks lõbusaks lähevad, siis juhtub asju.

See ökosüsteemm toimis tänu sellele, et inimestel oli hea meel üksteist leida. 
Ta oli tollaltõesti väike ka, ta oli ikkagi alla saja inimese kindlasti,  
võib-olla isegi alla viiekümne inimese alguses. Need olid siis seelise uue 
...
Kettaruumi ei maksa täna eriti palju erinevalt elektroonika valmistamisest 
utiliseerimisest.

Mul on kuidagi juhtunud niimoodi, et mul on see reaalne maailm, et kui ma panen 
tule vilkuma ja näen, kuidas mu tehtu  manifesteeru päris päris asjades, et 
...
riistvara tarkvara jaoks ja vastupidi. Selle kõige onkreetne töönimetus on 
...
riistvara valmistada kui sellega tarkvara peale kirjutada,  neid üritatakse 
...
probleemiks muutuma. Tõsi küll, töömeetodid ka muutuvad. Me kasutame täna võib 
olla töövahendid, mis iseenesest annavad näiteks tarkvaratiimile parema 
...
No vot see CTO ametit on kaht sorti. Tavaliselt on väikestes firmades, tähendab 
...
Kui vanasti vanasti väga ei tegeletud sellega, siis nüüd kus on tohutu kuhi 
investorite raha põlema pandud, ilma et sellest isegi sooja oleks saadud, et 
siis kõik on hakanud rääkima sellest, et su toodetud kellegile nagu tarvis 
päriselt ka olema. See tundub olevat mingi uuem asi, viimase paari aasta 
...
korraga põlema panna, nii et sooja ei saa,  selle aeg sai seal mõned aastad 
...
asi  selgem selles mõttes, et riistvara ei eskaleeru kui keegi teda osta. Sa ei 
...
juhtuda, et tarkvara, millest mitte kellegile mitte pennigi raha ei teki, on 
...
asjadest, mille ainus viga on see, et see fundamentaal järeldus, millele ta 
...
Üks oli see, et teda oli tarvis, mis tähendas, et  oli tugevn kliendipoolne 
...
utiliite, mis midagi kasulikku tegi, olid ju tegelikult kirjutatud kellelgi 
enda jaoks ära, paketeeritud ja saadetud laiali. Eestis seda, et tarkvaraga 
...
tänapäeval eks ole, see tarkvaratootmine on läinud niimoodi, et mul tuleb mingi 
...
vanasti otsiti probleemidele lahendust, siis nüüd otsitakse vastupidi ja see on 
 kõige suurema paradigma muutus selle kahekümne viie aasta jooksul.
