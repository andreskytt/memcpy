...
IBMi koopia või litsentsi alusel tehtud ES\index{Arvutid!ES 
EVM}\sidenote{ES EVM (\begin{russian}ЕС ЭВМ, единая система электронных 
вычислительных машин\end{russian}) oli sari IBM 
System/360\index{System/360} ja System/370\index{Arvutid!System/370} 
...
500\index{Amiga 500}\sidenote{Tuntud ka kui A500, oli Amiga 500 
...
MSX BASICuga\index{Keeled!BASIC!MSX 
...
samuti mu tädil. Autoritest oli Asimov\index{Isaac Asimov} 
kindlasti kõva sõna. 
...
isandad\index{\emph{Lord of the Rings}}. 
...
Viljandis lavaka\index{Lavakas}\index{Eesti Muusika- ja 
...
lavakas\index{Lavakas} ligi aasta, ent ühel hetkel sain aru, et see ei ole ikkagi see, mida ma teha tahan. 
