...
iga hommik ja iga õhtu mööda. Ja see, ma ei tea, ühele üheteistaastasele 
...
tehnoloogiliselt üsna kaugel. Kuigi protsessori tasandil sarnased, oli kõik 
seal peal nii erinev. 
...
aastat edasi, siis olid mingid Tartu Ülikooli arvutiklassid ja 
...
klaviatuurid vägagi kasutusel ja tegelikult siis \enquote{pidev 
...
mingi väga lahe asi. Kujuta ette, kui sa läheks kuskilt mööda, kus on 
...
Lendamine on  mingi asi, mis on universaalselt väga \emph{cool}, onju. Ja siis 
...
Ei, no klassivenna võtsin kaasa sinna ja ma mäletan, et oli selline eriti lahe
arutelu. Me saime aru, et see arutelu ei baseeru nagu kogul infol, mis meil on, 
...
paremaks. Aga  õpetame neid inimesi, kes õpetavad teisi. Näitame nendele 
...
kindlasti teha, sellega ma tegin igasuguseid asju. Kuulen mingit asja, proovin 
...
olid ikka nii ära \emph{tune}'itud, et viiul ja klaver ikkagi kostusid kõrvale 
...
esimest internetiühendust, üks oli Tallinnas KBFIs, ja  Tartu oma paikneski 
...
Ülikool ju ei jaksanud ikka 24/7 teha täienduskoolitusi. Seevastu 
üheteistaastastele kuttidelie pole mitte mingi probleem 24/7 seal kohal olla, või 
...
kes järgi ei jätnud, need lõpuks olid. 
...
Aga muusikaga oli jällegi teistmoodi. Suured inimesed kuulasid suurte inimeste 
...
siis ka mingid Treffneri tüübid. Ja vot siis tekkis selline segu keskkoolist, 
...
Miina Härma gümnaasiumi kutid tõid sinna mingisugused Smithid ja Cure'id ja 
...
käis konjaki ja kohvi koos joomine näiteks. Mida küll  keskkooliõpilased ja 
...
tegelikult suhteliselt kallim tegevus kui näiteks keeleõpe. Kuidagimoodi aitab 
...
kontsertidel, tegin intervjuusid ja kirjutasin arvustusi ja kõik oli nagu OK.
Aga ma käisin näiteringis ka samal ajal. Lõpuklassi kuskil veebruari-märtsikuus 
olid Viljandis\index{Viljandi} lavaka\index{Lavakas} sisseastumiskatsete 
eelvoorud. Mõtlesin, et äge, läheme Viljandisse trallima ja pullima ja 
seiklema. No ja sealt eelvoorust me sain edasi. Kool sai juba läbi ja siis olin
...
kutt nagu Toomas Mölder\index[ppl]{Mölder, Toomas}, kes oli NLIBi, ehk siis 
...
teade: \enquote{\emph{An orc enters the room}}. Selle peale ka täna
lükkab seltskonnal vererõhu kakskümmend prossa ülespoole. Mudasid oli veel, aga 
...
EC-klassis, mis oli alati tühi, kuna need arvutid olid jamad. Liivi tänava 
...
madala SLAga asja ma  väga palju ei ole ka hiljem näinud. See arvuti oli väga 
...
kell neli hommikul. Me kõik teame seda, et sulle mingil hetkel tuleb niisuguse 
...
seal klassis võrguühendus alati ei töötanud, aga NetHack oli kohalik. Senikaua, 
kuni keegi kuskil otsis, kus Viljo Soo\index[ppl]{Soo, Viljo} on, et ta meie 
modemitele restardi teeks, mängiti seda meie NetHacki. Mina ei arvanud sest 
...
mingid usuteadlased kohal oleksid olnud. Aga see oli OK.
...
\emph{skill} oli kõik olemas, siis EENet otsustas, et ta teeb  endalw täie 
...
meediaprofessor äkki praegu kuskil Rootsi ülikoolis ja kes on ka ERRi nõukogu 
...
Ja sealt tulid juba väga kiiresti IRCud\sidenote{\emph{Internet Relay Chat 
...
kellelegi autodeks ega suvilateks. Marek tegi europrojekti ja tuli, põmm, kümme 
...
tulid novembris. Aga vahet ei olnud, keegi ei arutanud seda, et kas tehakse. 
...
televisioonil juba \emph{live}  signaalihalduse kontseptsioon. Mis 
...
oli nagu ta oli kogu aeg nagu terviklik kinnine maailm, mis arenes mingit teist 
