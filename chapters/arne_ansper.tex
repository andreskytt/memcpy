...
programmeerida, need olid  vahvad. Siis olid seal Agat'id\index{Arvutid!Agat}, 
...
\enquote{Turbo-} eesliitega keeled Assembler, BASIC, C, C++, Delphi ja Pascal} 
...
ja C++ jaoks}, aga oli hoopis parem ja teistmoodi tehtud ja see ga töötas väga 
kenasti. 
...
\question{Ja teitpidi, ega sul ei olnud neid akende joonistamise asju võtta 
riiulist kümneid?}
...
\question{Mäletan, Fox Pro\index{Fox Pro} joonistas lausa mingeid varjusid 
akende taha}
...
Lepp\index[ppl]{Lepp, Andres}, on legenaarne TPI arvuti-mees, paljude meie 
...
kõige härjemad. Meil oli mingi 2400 ja MNP 5\sidenote{\emph{Microcom Network 
...
\question{Kes selle tagai oli? Keegi pidi ju selle tellimuse formuleerima, et 
...
Me olime mingis hästi varases europrojektis, ma mäletan, see võis olla 1995. 
...
krüpto jaoks põhiolemuses olulisi primitiive ja protsesse läbi realieerides?} 
...
võtmetega blokkšiffer} paralleelselt arvutada,  mitu blokki korraga. Ja siis 
...
krüptograafide poolt välja töötatud Rijndael blokkšifrii alamhulk. 1997. aastal 
...
\question{Ma arvan, et ega teised ka ei teajunud ja soft ju lõpuks ikkagi 
töötas ju}
...
\question{Sa oled kogend arhitekt ja tead, mida on vaja selleks, et projekt 
