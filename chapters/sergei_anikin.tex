...
ajakirja tiraažiks 850 000 eksemplari}. Ja siis aastal kaheksakümmend kuus
...
pealt\sidenote{Eri allikate alusel oli tegemist arvutiga
\begin{russian}Радио-86РК\end{russian}\index{Arvutid!Radio-86RK}, mis oli üks
edukamaid Nõukogude koduseks kasutamiseks mõeldud arvuteid. Kuigi Nõukogudemaal
kopeeriti ZX Spectrumit usinasti, oli selle arvuti puhul siiski väidetavasti
tegu originaalse disainiga}.Isa siis kõigepealt korjas need komponendid kokku,
...
mingid tegelased siis õppisid programmeerima BASCIus\index{Keeled!BASIC}. Siis
...
on pannud ka sellesama ZX Spectrumi\index{Arvutid!ZX Spectrum}, isegi mitu
...
Interface\index{Arvutiklubi!Interface}.
...
Reaalkoolis\index{Koolid!Reaalkool}, seal olid arvutiklassid, tundides.

\textbf{\enquote{Mis koolis sa ise käisid?}}

See on kool, number kakskümmend kuus\index{Koolid!Tallinna 26. Keskkool}. Ja
siis viimases klassis ma läksin Tõnismäe Reaalkooli\index{Koolid!Tõnismäe
Reaalkool} kus oli väga tugev matemaatika. Ja tegelikult seesama
...
lõpetasin kooli ja läksin ülikooli majandust õppima\index{Tallinna
...
Aga ma jällegi mõtlen, et see, kus ma praegu olen, ilmselt on ka põhjen
...
onju. Ma mäletan, meil oli kas viies või seitsmes\sidenote{Selle põlvkonna
inimestel, nii vene- kui eesti koolides, jäi üks klassi vahele, sest koolid
läksid kaheksakümnendate teisel poolel üle aasta võrra pikemale õppele}, minu
...
No see olümpiaadide küsimus jällegi, Mina ei saanud seal mingeid kohti, aga aga
...
Tegelikult nüüd kui ma olen siin Pipedrive's\index{Pipedrive} juba seitse
...
veeti ümberkaudsetesse majadesse kaablid ja asuti teenust müüma} firmad. Mõnes
väikeses rajoonis oli mingis oma kunn, kes pakkus seda sat-tvd kuutasu eest.
...
Programmeerimist õppisin raamatutest. Mul oli üks üks Pascali raamat, mis
õpetas objektorienteeritud programmeerimist, venekeelne raamat. See aitas mul
mõista, just objektorienteeritust. Ja ülikoolis tegelikult mõned ained olid
väga-väga kasulikud. Näiteks andmebaaside projekteerimine. Tänapäeval väga
paljud inimesed ei oska relatsioonilist andmebaasi projekteerida ja see ja see
on üks vajalikumaid oskusi, tegelikult, kui sa tahad isegi lihtsat süsteemi
kokku panna. Tänapäeval lahendatakse selliseid asju tihti lihtsalt jõuga.
...
seost. Minu jaoks arvuti on nii praktiline asi, kui kui olla saab. Eks
...
feilisin, sest mulle anti mingisuguse valemi programmeerimine. See pidi
Cs\index{Keeled!C} olema ja sellest pidi \emph{library} saama. No mul ei olnud
teadmisi. Ma ei teadnud, kuidas Cs kirjutada, ma ei saanud sellest valemist aru
(see oli kõrgemad matemaatika). Ühesõnaga, sellega ma feilisin. Aga milles ma
olin väga hea, oli meil Lotus Notes'i\index{Lotus Notes Domino} tarkvara, mida
kasutati suhtlemiseks omavahel ja soomlastega. See oli dokumendianadmebaas
tegelikult. Tal oli oma skriptimiskeel ja sellega siis ma kirjutasin
reisikindlustuse süsteemi kindlustusagentidele, et nad saaksid välja arvutada,
palju see reisimine maksab ja saaksid poliisi teha. Ja see oli internetipõhine
aastal 1997. Selle Dominoga oli võimalik, need samad dokumendid, mida sa muidu
Lotus Notes'i enda kliendiga nägid, oli võimalik ka veebiserveri kaudu, HTML
dokumentidena näidata.
...
Heiki}. Ja siis ma mõlemast pangast sain tööpakkumise umbes summa peale.
...
Rand\index[ppl]{Rand, Toomas}, kes tegelikult kirjutas kogu selle panga
...
Me olime Skype's\index{Skype}, ja siis ma tulin Pipedrive'i ja siin on meil
...
Pipedrive's\index{Pipedrive}. Ma olen siin juba seitse aastat olnud. Aastal
...
aitas Pipedrivel kasvada või see, et ta kasvas, aitas meil skaleerida
\emph{engineering}ut.
