...
\textbf{\enquote{Kuidas sina arvutite juurde sattusid?}}
...
\textbf{\enquote{Kust ta vajalikud jupid sai?}}
...
pealt\sidenote{\begin{russian}Радио-86РК\end{russian}\index{Arvutid!Radio-86RK}, populaarne
...
\textbf{\enquote{Miks sa seda tegid? Normaalne laps ju ei toksi niimoodi 
...
BASICus\index{Keeled!BASIC}. Lugesin raamatu läbi, sain aru, kuidas 
...
\textbf{\enquote{Sulle tehti väiksest peale selgeks, et võid küll üle jala 
...
ZX Spectrumi\index{Arvutid!ZX Spectrum}. Tegelesime ka 
...
\textbf{\enquote{Miks sulle elektroonikaosa huvi ei pakkunud?}}
...
\textbf{\enquote{Kes seda klubi pidas ja kus?}}

Seda vedas Nina Botina\index[ppl]{Botina, Nina}, kes töötas vist bioloogiainstituudis Mustamäe teel. Me käisime 
Reaalkoolis\index{Koolid!Tallinna 2. Keskkool}\index{Koolid!Reaalkool|see{Tallinna 2. Keskkool}} tundides,
seal olid arvutiklassid.

\textbf{\enquote{Mis koolis sa ise käisid?}}

Koolis number kakskümmend kuus\index{Koolid!Tallinna 26. Keskkool}. 
Viimasesse klassi läksin Tõnismäe Reaalkoolis\index{Koolid!Tõnismäe Reaalkool} 
...
\textbf{\enquote{Sa mainisid, et matemaatika tuli sul hästi välja. Kas käisid 
olümpiaadidel ka?}}
...
\textbf{\enquote{Jällegi tuleb välja, et matemaatikatunnis õpiti lisaks 
...
\textbf{\enquote{Miks sa läksid majandust õppima?}}
...
\textbf{\enquote{Kas sul oli mingi ettekujutus ka sellest, mida sa tahad pärast oma 
...
\textbf{\enquote{See on ju igavesti raske töö!}}
...
\textbf{\enquote{Kas sa siis programmeerisid juba tõsisemaid asju ka 
...
\textbf{\enquote{Kust sa infot said? Accessis programmeerimine ei ole 
...
\textbf{\enquote{Kas sinu reaalainete ja arvutihuvi juurde käis ka 
...
\textbf{\enquote{Mis su esimene päris programmeerijatöö oli ja millal?}}
...
See kogemus aitas mul saada Hansapanga\index{Pangad!Hansapank} internetipanga 
tiimi.
...
SEBs\index{Pangad!SEB|see{Ühispank}} ehk toonases Ühispangas\index{Pangad!Ühispank} ma ei 
saanud isegi vist jutule, aga Hoiupangas\index{Pangad!Hoiupank} rääkisin Aleksei 
...
\textbf{\enquote{See tähendab, et pidid suhteliselt ruttu hakkama 
...
\textbf{\enquote{See kõik on mulle üllatus. Mina läksin sinna panka 
...
sai PL/SQLiga\index{Keeled!PL/SQL} tekitada HTMLi, mida kliendid 
...
\textbf{\enquote{See arhitektuur oli siis toonaseid vahendeid kasutades täpselt selline, nagu tänased \emph{de facto} 
...
\textbf{\enquote{Seal tehti veel mõningaid huvitavaid asju, näiteks olid peidetud raamid, 
...
\textbf{\enquote{Kui sa nüüd tagasi mõtled, siis mis sulle andis põhja, et selline asi teha? Oli see 
...
tööd. Sellepärast see saigi hall. Tol ajal me tegime ka hanza.net'i\index{Pangad!Hansapank!hanza.net} 
ja see oli värviline, disaini mõiste oli juba olemas.

\textbf{\enquote{Sellise asja peale tänapäeval sageli isegi ei mõelda, kust 
see nõue tuli?}}
...
\textbf{\enquote{Kui ilusast arhitektuurist edasi minna, siis milline on ilus kood?}}
...
\textbf{\enquote{Tagantjärele mõeldes oli kogu see 
...
\textbf{\enquote{Mida sa praegu teed?}}
