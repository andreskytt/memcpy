...
kohvikute, kontorite ja loomeruumidega.} Nüüd on seal kõige popim koht noorte seas, Kalamaja ja Lendav Taldrik.
...
ajakirja tiraa{\v z} 850 000 eksemplari.} Aastal 1986 avaldati seal 
...
Bulõtšovit\sidenote[][]{Kir Bulõt\v{s}ov (1934--2003), Nõukogude 
...
valemi programmeerimine. See pidi C-s\index{C} olema ja sellest pidi 
...
internetipanga asemel tegelema hoopis Light Telleri\phantomsection\label{sisu:teller} nimelise telleri 
töökohasüsteemiga?}
...
Tegelikult tehti väga julge otsus ehitada interneti telleriprogrammi. Otsustajateks olid ilmselt needsamad Vilve\index[ppl]{Vene, Vilve} ja 
...
veebirakendused. \mbox{JavaScript}\index{JavaScript} jooksis brauseris ja 
...
modemi\sidenote{Telefoniliine kasutavat sidet 
