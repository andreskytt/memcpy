...
\begin{russian}\enquote{эта команда работает хорошо}\end{russian} ehk „see käsk
...
„Programmeerimine keeles “. Uurisin, mis see on. Ema vaatas, et vist mingi vana asi.
...
Ulmehuvi natuke oli. Mul õnnestus saada venekeelsed „Asumi“\sidenote{\label{sidenote!asum}Isaac
...
kohta, mida ta oli „Horisondist“ või mujalt lugenud.
Väga põnev oli. 
...
„Наука, природа, человек“\end{russian}\sidenote{Rahvusvaheline
...
Jaanus} jagas mulle kunagi raamatut „The Java Language Specification“,
...
„Dune'i“\index{Dune} ja ma vaatasin, kuidas see käib. Mängimisega ei olnud mul erilist
