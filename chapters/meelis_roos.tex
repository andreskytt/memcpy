...
DVK-d\index{DVK}\sidenote{\begin{russian}ДВК, Диалоговый вычислительный
...
Tartus Tähe tn.4, nn. füüsikamajas\index{Tartu Ülikool!Füüsikahoone}. Isa töötas seal elektromeetria laboris
...
oli Wall\index{Wall}, seina pommitamine tennisepalliga. Isa pani mind
...
Keskkoolis\index{Tartu 12. Keskkool}. Meil oli üks ukrainlanna, Zinaida
...
kutsuti Nõkku\index{Nõo Keskkool}. Hilisem ülemus
...
Tartus\index{Tartu 1. Keskkool|see{Hugo
...
mängida. Ostsin omale üheksanda klassi lõpus ZX Spectrum-i\index{ZX
...
Assembleris\index{Assembler}. Sellest arvutist võis lõpuni aru saada.
...
Muda\index{Muda}\sidenote{\label{sidenote!muda}Originaalis \enquote{Multi User Dungeon
...
NT\index{Windows NT} on selle sisemiselt pärinud või umbes niimoodi. Nii
...
rubiini\index{rubiin.physic.ut.ee} ja talk-is Ville
...
korra kasutanud. Math.ut.ee-s\index{math.ut.ee}, kui tekkis online
võrk, tuli 386BSD\index{386BSD}. Ja see uuendati 93. aasta lõpus mingile
...
Linux\index{Linux}. Versioon 0.99pl3 või midagi, kui õigesti mäletan.
...
romulus.cs.ut.ee\index{romulus.cs.ut.ee}) konto ja põhjendasin seda, et
...
Dune'i\index{Dune} mängis Veljo näiteks õhtul näiteks millalgi kui ma
...
PS/2\index{IBM PS/2}\sidenote{PS/2 oli IBMi kolmas personaalarvutite
...
asja haljas assembleris\index{Assembler} ja sai kolme sekundiga. Muidu
