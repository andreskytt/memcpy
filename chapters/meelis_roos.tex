...
Ulmehuvi natuke oli. Mul õnnestus saada venekeelsed \enquote{Asumi}\sidenote{\phantomsection\label{sidenote!asum}Isaac
...
Spectrum},\sidenote[][]{Sinclair Researchi poolt 1982. aastal
...
(ULA -- \emph{Uncommitted Logic Array}). Nõukogude Liidus tehtud Sinclairi koopiad kasutasid
...
modifitseerinud Meelis Roos}.\sidenote[][-1.4mm]{Enne kui vabavaralised tsentraliseeritud
...
Muda\index{Muda}\sidenote{\phantomsection\label{sidenote!muda}\enquote{Multi User Dungeon
...
esimene \emph{online}-konto oli masinas vask.ut.ee\index{vask.ut.ee}. See oli
...
kursaõele Pascalis programmeerimist õpetada, aga ainult VAXu klass\index{Tartu Ülikool!Liivi õppehoone!Vase klass}\sidenote{Vt ka märkust lk \pageref{sidenote!vaks}.} oli vaba,
...
PS/2-l\index{IBM PS/2}\sidenote[][-3mm]{PS/2 oli IBMi kolmas personaalarvutite
...
süsteemidel on \emph{root}'i (mis eesti kõnekeeles mugandub tihtipeale sõnaks
...
kutsuti mind Arula motelli Küberi\sidenote[][-1.2cm]{Kõnekeeles on
