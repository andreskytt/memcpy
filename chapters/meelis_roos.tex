...
Selline umbes kuupmeetrine kast pluss kettad seal kõrval\sidenote{Huvitav, et Meelis meenutab just \emph{serverit} samas kui Asko (lk. \pageref{\label{sisu:vase_klass}}) ja Jaanus (lk ) meenutavad \emph{terminale}. Kes millega kokku puutus\ldots}. Teine VAX oli
