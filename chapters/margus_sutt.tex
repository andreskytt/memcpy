...
Rebane pistis mulle pihku Kernighan-Ritchie\index{The C 
Programming Language}\sidenote{Kuulus valgete kaante ja 
...
\question{Kuidas te radari softi töökindluse tagasite?}
...
Jah, MamBoxi\index{MamBox} \emph{point} olin mõnda aega ja siis sai 
...
Rusalepad\sidenote[][]{Ilmselt peab Margus silmas Ervin ja Maret 
...
\enquote{Rogue}\index{Rogue}\index{NetHack}\sidenote[][]{Esimene mäng, kus tuli tekstipõhisel ekraanil programmi poolt genereeritud 
...
tegelaste laipadele. Hiljem nimetatigi sedalaadi mänge (polulaarsemad \enquote{Hack}, 
\enquote{Nethack}, \enquote{Moria}, \enquote{Angband}) ühise nimetajaga \emph{roguelike} ehk 
\emph{rogue}'i-sarnased.} või \enquote{NetHack}.\sidenote[][]{Vt ka lk 
\pageref{sisu:nethack}.}

\question{Mis versiooni\sidenote[][]{\enquote{NetHack} on pigem kultuuriline 
...
see mängu pidevat arengut, kuid teisalt ka seda, et mängijad peavad vaid üht 
...
\emph{priest}.\sidenote[][]{\enquote{NetHackis} on 13 rolli, neist igaühel unikaalsed 
...
võimekus on vastupanu mürkidele) on \enquote{NetHacki} austajate hulgas üsna eepilistes 
mõõtmetes saavutus.}
...
Tiiduma\index[ppl]{Tiidumaa, Asko} oli nii-öelda ühika \emph{sysop},\sidenote{Asko mäletab, 
et ta oli küll idee tekkimise juures ja võttis hiljem \emph{sysopi} rolli üle, 
