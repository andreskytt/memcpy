...
Gümnaasium\index{Nõmme Gümnaasium|see{Tallinna 10. keskkool}}. Ja kui ma 
...
Elektronika\index{Elektronika} arvutid. Ja nad olid omavahel võrgus 
niimoodi, et  õpetaja laua peal oli siis flopidraiviga 
Iskra\index{Iskra}. Nendes Elektronikates jooksis ainult Basic. 
Lükkasid käima, Basic\index{BASIC} kohe jooksis, said koodi 
...
arvutiringis\index{TPI arvutiring}. Ja see on see kuulus 
...
Yamaha-d\index{Yamaha MSX}, MicroBee-d\index{MicroBee} ja 
Robotron 1715-d\index{Robotron!Robotron 1715}. Kolmes reas. Keskel 
...
\emph{Except}, minu esimene üldse töö, välja arvatud TPL-id\sidenote{TPL - Töö ja 
...
kirjutab kahe reaga sellesama koodi. Turbo C-s.\index{Turbo C}
...
\emph{node}, muidugi Mamersil\index[ppl]{Mamers, Tarmo} Mambox\index{MamBox}. 
...
mingi perekond itikaid, aga ma ei mäleta, mis nende nimed olid\sidenote{Tarmo Mamers\index[ppl]{Mamers, Tarmo} arvab, et tõenäoliselt oli tegu perekond Pruulmannidega, ehk muudestki juttudest läbi käiva Jaan Pruulmanni\index[ppl]{Pruulmann, Jaan} ja tema abikaasaga.}. Igatahes keegi 
...
Ivar Zarans\index[ppl]{Zarans, Ivar} sai ju Helinaga\index[ppl]{Võrno, Helina} 
...
Foreksis\index{Forekspank}. Ma veel mäletan hästi seda, et 
...
koos Eesti Vabariigi presidendiga\index[ppl]{Kaljulaid, Kersti}. Jälle ühe sugulase tõttu. See sugulane 
