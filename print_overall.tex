...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Mõeldud olema ka mitte-arvutiinimesele üldjoontes arusaadav: konteksti mõistmiseks olulised terminid on lahti seletatud, kuid detailid otsib huviline ise välja. Samas ei ole eesmärk anda struktureeritud ülevaadet arvutustehnika ajaloost või vanade tehnoloogiate toimimisest
...
\begin{itemize}
	...
	\begin{itemize}
		\item Kõps \& Rops
		\begin{itemize}
			\item Tarvi Martens portis Agati peale
			\item ROPS Algoli baasil KÕPS \enquote{nagu  HPGL aga eesti keeles} (Tarvi)
			\item Aldo: Minuteada tehti Tartu Ülikoolis. Kui ma õigesti mäletan, siis Rops oli tekstiväljundiga nn tavaline programmeerimiskeel. Kõps oli graafilise väljundiga - kasutades protseduure “punkt”, “joon”, “ring” jne tulid suurest tähtprinterist tärnidest moodustatud pseudograafilised kujundid ja joonised
			\item Uuno Puus (Arne esimene arvutiõpetaja Nõos)
			\begin{itemize}
				\item Keelte KÕPS ja ROPS kohta võin üsna kindlalt väita, et need mõtlesime välja Nõo Keskkoli arvutuskeskuses. KÕPS oli kilpkonna juhtimise keele Eesti versioon (täpne ingliskeelne allikas ja ideoloogia pole mul praegu meeles) ja ROPS selle edasiarendus. ROPS võimaldas arvutusi teha (KÕPS oli vaid joonistamiseks)
				\item aastaarv võiks olla millalgi 80-ndatel, aga milline number seal 8 kõrval kõige täpsem on, seda ma ei oska praegu öelda. Teen järgmise nädalani uurimistööd, ehk õnnestub midagi teada saada=meelde tuletada.
				\item lisaks aastaarvudest, et ilmselt oli see 80-ndate teises pooles, sest ideoloogia pärineb Seymour Papert-ilt vt http://hackeducation.com/2015/04/10/mindstorms Ja see sõnastati 1984
			\end{itemize}
		\end{itemize}
	\end{itemize}
\end{itemize}
